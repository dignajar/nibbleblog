...
class Url {
	...
	public static function post($id, $slug, $permalink=false)
	{
		if($permalink)
		{
			return HTML_PATH_ROOT.'post-'.$id.'/'.$slug;
		}
		else
		{
			return HTML_PATH_ROOT.'index.php?controller=post&action=view&id_post='.$id;
		}
	}
